...
![Data Split Proportions](../output/eda/data_split_pie_chart.png){#fig-pie-chart width=70%}
...
![Distribution of Wine Auality Scores](../output/eda/wine_quality_histogram.png){#fig-wine-quality-hist width=70%}
...
#| tbl-cap: Table of best model parameters
